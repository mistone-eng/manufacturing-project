...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x86d/DualSensor
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/DualSensor-gnumk_linux_x86-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/DualSensor-gnumk_linux_x86-Debug/DualSensor.c.o
	DEP_FILES = ../../../build/DualSensor-gnumk_linux_x86-Debug/DualSensor.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x86/DualSensor
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/DualSensor-gnumk_linux_x86-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/DualSensor-gnumk_linux_x86-Release/DualSensor.c.o
	DEP_FILES = ../../../build/DualSensor-gnumk_linux_x86-Release/DualSensor.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f DualSensor-Linux_X86.mk all-dep
	$(SILENT) $(MAKE) -f DualSensor-Linux_X86.mk all-obj
...
../../../build/DualSensor-gnumk_linux_x86-Debug/DualSensor.c.o ../../../build/DualSensor-gnumk_linux_x86-Debug/DualSensor.c.d: src/DualSensor.c
	$(SILENT) $(info GccX86 src/DualSensor.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/DualSensor-gnumk_linux_x86-Debug/DualSensor.c.o -c src/DualSensor.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/DualSensor-gnumk_linux_x86-Release/DualSensor.c.o ../../../build/DualSensor-gnumk_linux_x86-Release/DualSensor.c.d: src/DualSensor.c
	$(SILENT) $(info GccX86 src/DualSensor.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/DualSensor-gnumk_linux_x86-Release/DualSensor.c.o -c src/DualSensor.c -MMD -MP
...
include ../../../build/DualSensor-gnumk_linux_x86-Debug/DualSensor.c.d

endif

ifeq ($(config),Release)

include ../../../build/DualSensor-gnumk_linux_x86-Release/DualSensor.c.d
