...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/ReceiveProfile
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveProfile-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveProfile-gnumk_linux_x64-Debug/ReceiveProfile.c.o
	DEP_FILES = ../../../build/ReceiveProfile-gnumk_linux_x64-Debug/ReceiveProfile.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/ReceiveProfile
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveProfile-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveProfile-gnumk_linux_x64-Release/ReceiveProfile.c.o
	DEP_FILES = ../../../build/ReceiveProfile-gnumk_linux_x64-Release/ReceiveProfile.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveProfile-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveProfile-Linux_X64.mk all-obj
...
../../../build/ReceiveProfile-gnumk_linux_x64-Debug/ReceiveProfile.c.o ../../../build/ReceiveProfile-gnumk_linux_x64-Debug/ReceiveProfile.c.d: src/ReceiveProfile.c
	$(SILENT) $(info GccX64 src/ReceiveProfile.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveProfile-gnumk_linux_x64-Debug/ReceiveProfile.c.o -c src/ReceiveProfile.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveProfile-gnumk_linux_x64-Release/ReceiveProfile.c.o ../../../build/ReceiveProfile-gnumk_linux_x64-Release/ReceiveProfile.c.d: src/ReceiveProfile.c
	$(SILENT) $(info GccX64 src/ReceiveProfile.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveProfile-gnumk_linux_x64-Release/ReceiveProfile.c.o -c src/ReceiveProfile.c -MMD -MP
...
include ../../../build/ReceiveProfile-gnumk_linux_x64-Debug/ReceiveProfile.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveProfile-gnumk_linux_x64-Release/ReceiveProfile.c.d
