...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/ReceiveMeasurement
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug/ReceiveMeasurement.c.o
	DEP_FILES = ../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug/ReceiveMeasurement.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/ReceiveMeasurement
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveMeasurement-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveMeasurement-gnumk_linux_x64-Release/ReceiveMeasurement.c.o
	DEP_FILES = ../../../build/ReceiveMeasurement-gnumk_linux_x64-Release/ReceiveMeasurement.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveMeasurement-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveMeasurement-Linux_X64.mk all-obj
...
../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug/ReceiveMeasurement.c.o ../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug/ReceiveMeasurement.c.d: src/ReceiveMeasurement.c
	$(SILENT) $(info GccX64 src/ReceiveMeasurement.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug/ReceiveMeasurement.c.o -c src/ReceiveMeasurement.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveMeasurement-gnumk_linux_x64-Release/ReceiveMeasurement.c.o ../../../build/ReceiveMeasurement-gnumk_linux_x64-Release/ReceiveMeasurement.c.d: src/ReceiveMeasurement.c
	$(SILENT) $(info GccX64 src/ReceiveMeasurement.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveMeasurement-gnumk_linux_x64-Release/ReceiveMeasurement.c.o -c src/ReceiveMeasurement.c -MMD -MP
...
include ../../../build/ReceiveMeasurement-gnumk_linux_x64-Debug/ReceiveMeasurement.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveMeasurement-gnumk_linux_x64-Release/ReceiveMeasurement.c.d
