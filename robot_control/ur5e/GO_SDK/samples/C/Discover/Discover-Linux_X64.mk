...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/Discover
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/Discover-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/Discover-gnumk_linux_x64-Debug/Discover.c.o
	DEP_FILES = ../../../build/Discover-gnumk_linux_x64-Debug/Discover.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/Discover
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/Discover-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/Discover-gnumk_linux_x64-Release/Discover.c.o
	DEP_FILES = ../../../build/Discover-gnumk_linux_x64-Release/Discover.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f Discover-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f Discover-Linux_X64.mk all-obj
...
../../../build/Discover-gnumk_linux_x64-Debug/Discover.c.o ../../../build/Discover-gnumk_linux_x64-Debug/Discover.c.d: src/Discover.c
	$(SILENT) $(info GccX64 src/Discover.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/Discover-gnumk_linux_x64-Debug/Discover.c.o -c src/Discover.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/Discover-gnumk_linux_x64-Release/Discover.c.o ../../../build/Discover-gnumk_linux_x64-Release/Discover.c.d: src/Discover.c
	$(SILENT) $(info GccX64 src/Discover.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/Discover-gnumk_linux_x64-Release/Discover.c.o -c src/Discover.c -MMD -MP
...
include ../../../build/Discover-gnumk_linux_x64-Debug/Discover.c.d

endif

ifeq ($(config),Release)

include ../../../build/Discover-gnumk_linux_x64-Release/Discover.c.d
