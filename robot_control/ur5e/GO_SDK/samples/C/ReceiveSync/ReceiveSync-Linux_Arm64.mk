...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_arm64d/ReceiveSync
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveSync-gnumk_linux_arm64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveSync-gnumk_linux_arm64-Debug/ReceiveSync.c.o
	DEP_FILES = ../../../build/ReceiveSync-gnumk_linux_arm64-Debug/ReceiveSync.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_arm64/ReceiveSync
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveSync-gnumk_linux_arm64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveSync-gnumk_linux_arm64-Release/ReceiveSync.c.o
	DEP_FILES = ../../../build/ReceiveSync-gnumk_linux_arm64-Release/ReceiveSync.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveSync-Linux_Arm64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveSync-Linux_Arm64.mk all-obj
...
../../../build/ReceiveSync-gnumk_linux_arm64-Debug/ReceiveSync.c.o ../../../build/ReceiveSync-gnumk_linux_arm64-Debug/ReceiveSync.c.d: src/ReceiveSync.c
	$(SILENT) $(info GccArm64 src/ReceiveSync.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveSync-gnumk_linux_arm64-Debug/ReceiveSync.c.o -c src/ReceiveSync.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveSync-gnumk_linux_arm64-Release/ReceiveSync.c.o ../../../build/ReceiveSync-gnumk_linux_arm64-Release/ReceiveSync.c.d: src/ReceiveSync.c
	$(SILENT) $(info GccArm64 src/ReceiveSync.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveSync-gnumk_linux_arm64-Release/ReceiveSync.c.o -c src/ReceiveSync.c -MMD -MP
...
include ../../../build/ReceiveSync-gnumk_linux_arm64-Debug/ReceiveSync.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveSync-gnumk_linux_arm64-Release/ReceiveSync.c.d
