...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_arm64d/BackupRestore
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/BackupRestore-gnumk_linux_arm64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/BackupRestore-gnumk_linux_arm64-Debug/BackupRestore.c.o
	DEP_FILES = ../../../build/BackupRestore-gnumk_linux_arm64-Debug/BackupRestore.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_arm64/BackupRestore
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/BackupRestore-gnumk_linux_arm64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/BackupRestore-gnumk_linux_arm64-Release/BackupRestore.c.o
	DEP_FILES = ../../../build/BackupRestore-gnumk_linux_arm64-Release/BackupRestore.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f BackupRestore-Linux_Arm64.mk all-dep
	$(SILENT) $(MAKE) -f BackupRestore-Linux_Arm64.mk all-obj
...
../../../build/BackupRestore-gnumk_linux_arm64-Debug/BackupRestore.c.o ../../../build/BackupRestore-gnumk_linux_arm64-Debug/BackupRestore.c.d: src/BackupRestore.c
	$(SILENT) $(info GccArm64 src/BackupRestore.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/BackupRestore-gnumk_linux_arm64-Debug/BackupRestore.c.o -c src/BackupRestore.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/BackupRestore-gnumk_linux_arm64-Release/BackupRestore.c.o ../../../build/BackupRestore-gnumk_linux_arm64-Release/BackupRestore.c.d: src/BackupRestore.c
	$(SILENT) $(info GccArm64 src/BackupRestore.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/BackupRestore-gnumk_linux_arm64-Release/BackupRestore.c.o -c src/BackupRestore.c -MMD -MP
...
include ../../../build/BackupRestore-gnumk_linux_arm64-Debug/BackupRestore.c.d

endif

ifeq ($(config),Release)

include ../../../build/BackupRestore-gnumk_linux_arm64-Release/BackupRestore.c.d
