...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x86d/MultiSensorLayout
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/MultiSensorLayout-gnumk_linux_x86-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/MultiSensorLayout-gnumk_linux_x86-Debug/MultiSensorLayout.c.o
	DEP_FILES = ../../../build/MultiSensorLayout-gnumk_linux_x86-Debug/MultiSensorLayout.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x86/MultiSensorLayout
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/MultiSensorLayout-gnumk_linux_x86-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/MultiSensorLayout-gnumk_linux_x86-Release/MultiSensorLayout.c.o
	DEP_FILES = ../../../build/MultiSensorLayout-gnumk_linux_x86-Release/MultiSensorLayout.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f MultiSensorLayout-Linux_X86.mk all-dep
	$(SILENT) $(MAKE) -f MultiSensorLayout-Linux_X86.mk all-obj
...
../../../build/MultiSensorLayout-gnumk_linux_x86-Debug/MultiSensorLayout.c.o ../../../build/MultiSensorLayout-gnumk_linux_x86-Debug/MultiSensorLayout.c.d: src/MultiSensorLayout.c
	$(SILENT) $(info GccX86 src/MultiSensorLayout.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/MultiSensorLayout-gnumk_linux_x86-Debug/MultiSensorLayout.c.o -c src/MultiSensorLayout.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/MultiSensorLayout-gnumk_linux_x86-Release/MultiSensorLayout.c.o ../../../build/MultiSensorLayout-gnumk_linux_x86-Release/MultiSensorLayout.c.d: src/MultiSensorLayout.c
	$(SILENT) $(info GccX86 src/MultiSensorLayout.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/MultiSensorLayout-gnumk_linux_x86-Release/MultiSensorLayout.c.o -c src/MultiSensorLayout.c -MMD -MP
...
include ../../../build/MultiSensorLayout-gnumk_linux_x86-Debug/MultiSensorLayout.c.d

endif

ifeq ($(config),Release)

include ../../../build/MultiSensorLayout-gnumk_linux_x86-Release/MultiSensorLayout.c.d
