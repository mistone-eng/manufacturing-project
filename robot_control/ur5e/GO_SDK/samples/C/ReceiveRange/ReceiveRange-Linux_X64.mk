...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/ReceiveRange
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveRange-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveRange-gnumk_linux_x64-Debug/ReceiveRange.c.o
	DEP_FILES = ../../../build/ReceiveRange-gnumk_linux_x64-Debug/ReceiveRange.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/ReceiveRange
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveRange-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveRange-gnumk_linux_x64-Release/ReceiveRange.c.o
	DEP_FILES = ../../../build/ReceiveRange-gnumk_linux_x64-Release/ReceiveRange.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveRange-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveRange-Linux_X64.mk all-obj
...
../../../build/ReceiveRange-gnumk_linux_x64-Debug/ReceiveRange.c.o ../../../build/ReceiveRange-gnumk_linux_x64-Debug/ReceiveRange.c.d: src/ReceiveRange.c
	$(SILENT) $(info GccX64 src/ReceiveRange.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveRange-gnumk_linux_x64-Debug/ReceiveRange.c.o -c src/ReceiveRange.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveRange-gnumk_linux_x64-Release/ReceiveRange.c.o ../../../build/ReceiveRange-gnumk_linux_x64-Release/ReceiveRange.c.d: src/ReceiveRange.c
	$(SILENT) $(info GccX64 src/ReceiveRange.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveRange-gnumk_linux_x64-Release/ReceiveRange.c.o -c src/ReceiveRange.c -MMD -MP
...
include ../../../build/ReceiveRange-gnumk_linux_x64-Debug/ReceiveRange.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveRange-gnumk_linux_x64-Release/ReceiveRange.c.d
