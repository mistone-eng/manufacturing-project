...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_arm64d/AlignmentStationary
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/AlignmentStationary-gnumk_linux_arm64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/AlignmentStationary-gnumk_linux_arm64-Debug/AlignmentStationary.c.o
	DEP_FILES = ../../../build/AlignmentStationary-gnumk_linux_arm64-Debug/AlignmentStationary.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_arm64/AlignmentStationary
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/AlignmentStationary-gnumk_linux_arm64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/AlignmentStationary-gnumk_linux_arm64-Release/AlignmentStationary.c.o
	DEP_FILES = ../../../build/AlignmentStationary-gnumk_linux_arm64-Release/AlignmentStationary.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f AlignmentStationary-Linux_Arm64.mk all-dep
	$(SILENT) $(MAKE) -f AlignmentStationary-Linux_Arm64.mk all-obj
...
../../../build/AlignmentStationary-gnumk_linux_arm64-Debug/AlignmentStationary.c.o ../../../build/AlignmentStationary-gnumk_linux_arm64-Debug/AlignmentStationary.c.d: src/AlignmentStationary.c
	$(SILENT) $(info GccArm64 src/AlignmentStationary.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/AlignmentStationary-gnumk_linux_arm64-Debug/AlignmentStationary.c.o -c src/AlignmentStationary.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/AlignmentStationary-gnumk_linux_arm64-Release/AlignmentStationary.c.o ../../../build/AlignmentStationary-gnumk_linux_arm64-Release/AlignmentStationary.c.d: src/AlignmentStationary.c
	$(SILENT) $(info GccArm64 src/AlignmentStationary.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/AlignmentStationary-gnumk_linux_arm64-Release/AlignmentStationary.c.o -c src/AlignmentStationary.c -MMD -MP
...
include ../../../build/AlignmentStationary-gnumk_linux_arm64-Debug/AlignmentStationary.c.d

endif

ifeq ($(config),Release)

include ../../../build/AlignmentStationary-gnumk_linux_arm64-Release/AlignmentStationary.c.d
