...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_arm64d/ReceiveAsync
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveAsync-gnumk_linux_arm64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveAsync-gnumk_linux_arm64-Debug/ReceiveAsync.c.o
	DEP_FILES = ../../../build/ReceiveAsync-gnumk_linux_arm64-Debug/ReceiveAsync.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_arm64/ReceiveAsync
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveAsync-gnumk_linux_arm64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveAsync-gnumk_linux_arm64-Release/ReceiveAsync.c.o
	DEP_FILES = ../../../build/ReceiveAsync-gnumk_linux_arm64-Release/ReceiveAsync.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveAsync-Linux_Arm64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveAsync-Linux_Arm64.mk all-obj
...
../../../build/ReceiveAsync-gnumk_linux_arm64-Debug/ReceiveAsync.c.o ../../../build/ReceiveAsync-gnumk_linux_arm64-Debug/ReceiveAsync.c.d: src/ReceiveAsync.c
	$(SILENT) $(info GccArm64 src/ReceiveAsync.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveAsync-gnumk_linux_arm64-Debug/ReceiveAsync.c.o -c src/ReceiveAsync.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveAsync-gnumk_linux_arm64-Release/ReceiveAsync.c.o ../../../build/ReceiveAsync-gnumk_linux_arm64-Release/ReceiveAsync.c.d: src/ReceiveAsync.c
	$(SILENT) $(info GccArm64 src/ReceiveAsync.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveAsync-gnumk_linux_arm64-Release/ReceiveAsync.c.o -c src/ReceiveAsync.c -MMD -MP
...
include ../../../build/ReceiveAsync-gnumk_linux_arm64-Debug/ReceiveAsync.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveAsync-gnumk_linux_arm64-Release/ReceiveAsync.c.d
