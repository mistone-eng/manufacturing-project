...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/Configure
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/Configure-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/Configure-gnumk_linux_x64-Debug/Configure.c.o
	DEP_FILES = ../../../build/Configure-gnumk_linux_x64-Debug/Configure.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/Configure
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/Configure-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/Configure-gnumk_linux_x64-Release/Configure.c.o
	DEP_FILES = ../../../build/Configure-gnumk_linux_x64-Release/Configure.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f Configure-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f Configure-Linux_X64.mk all-obj
...
../../../build/Configure-gnumk_linux_x64-Debug/Configure.c.o ../../../build/Configure-gnumk_linux_x64-Debug/Configure.c.d: src/Configure.c
	$(SILENT) $(info GccX64 src/Configure.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/Configure-gnumk_linux_x64-Debug/Configure.c.o -c src/Configure.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/Configure-gnumk_linux_x64-Release/Configure.c.o ../../../build/Configure-gnumk_linux_x64-Release/Configure.c.d: src/Configure.c
	$(SILENT) $(info GccX64 src/Configure.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/Configure-gnumk_linux_x64-Release/Configure.c.o -c src/Configure.c -MMD -MP
...
include ../../../build/Configure-gnumk_linux_x64-Debug/Configure.c.d

endif

ifeq ($(config),Release)

include ../../../build/Configure-gnumk_linux_x64-Release/Configure.c.d
