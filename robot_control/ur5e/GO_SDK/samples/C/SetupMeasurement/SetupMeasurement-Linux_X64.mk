...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/SetupMeasurement
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/SetupMeasurement-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/SetupMeasurement-gnumk_linux_x64-Debug/SetupMeasurement.c.o
	DEP_FILES = ../../../build/SetupMeasurement-gnumk_linux_x64-Debug/SetupMeasurement.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/SetupMeasurement
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/SetupMeasurement-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/SetupMeasurement-gnumk_linux_x64-Release/SetupMeasurement.c.o
	DEP_FILES = ../../../build/SetupMeasurement-gnumk_linux_x64-Release/SetupMeasurement.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f SetupMeasurement-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f SetupMeasurement-Linux_X64.mk all-obj
...
../../../build/SetupMeasurement-gnumk_linux_x64-Debug/SetupMeasurement.c.o ../../../build/SetupMeasurement-gnumk_linux_x64-Debug/SetupMeasurement.c.d: src/SetupMeasurement.c
	$(SILENT) $(info GccX64 src/SetupMeasurement.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/SetupMeasurement-gnumk_linux_x64-Debug/SetupMeasurement.c.o -c src/SetupMeasurement.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/SetupMeasurement-gnumk_linux_x64-Release/SetupMeasurement.c.o ../../../build/SetupMeasurement-gnumk_linux_x64-Release/SetupMeasurement.c.d: src/SetupMeasurement.c
	$(SILENT) $(info GccX64 src/SetupMeasurement.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/SetupMeasurement-gnumk_linux_x64-Release/SetupMeasurement.c.o -c src/SetupMeasurement.c -MMD -MP
...
include ../../../build/SetupMeasurement-gnumk_linux_x64-Debug/SetupMeasurement.c.d

endif

ifeq ($(config),Release)

include ../../../build/SetupMeasurement-gnumk_linux_x64-Release/SetupMeasurement.c.d
