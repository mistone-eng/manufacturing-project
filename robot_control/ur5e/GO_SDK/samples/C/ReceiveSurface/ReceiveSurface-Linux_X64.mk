...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/ReceiveSurface
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveSurface-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveSurface-gnumk_linux_x64-Debug/ReceiveSurface.c.o
	DEP_FILES = ../../../build/ReceiveSurface-gnumk_linux_x64-Debug/ReceiveSurface.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/ReceiveSurface
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveSurface-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveSurface-gnumk_linux_x64-Release/ReceiveSurface.c.o
	DEP_FILES = ../../../build/ReceiveSurface-gnumk_linux_x64-Release/ReceiveSurface.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveSurface-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveSurface-Linux_X64.mk all-obj
...
../../../build/ReceiveSurface-gnumk_linux_x64-Debug/ReceiveSurface.c.o ../../../build/ReceiveSurface-gnumk_linux_x64-Debug/ReceiveSurface.c.d: src/ReceiveSurface.c
	$(SILENT) $(info GccX64 src/ReceiveSurface.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveSurface-gnumk_linux_x64-Debug/ReceiveSurface.c.o -c src/ReceiveSurface.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveSurface-gnumk_linux_x64-Release/ReceiveSurface.c.o ../../../build/ReceiveSurface-gnumk_linux_x64-Release/ReceiveSurface.c.d: src/ReceiveSurface.c
	$(SILENT) $(info GccX64 src/ReceiveSurface.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveSurface-gnumk_linux_x64-Release/ReceiveSurface.c.o -c src/ReceiveSurface.c -MMD -MP
...
include ../../../build/ReceiveSurface-gnumk_linux_x64-Debug/ReceiveSurface.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveSurface-gnumk_linux_x64-Release/ReceiveSurface.c.d
