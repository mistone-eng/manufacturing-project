...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/AlignmentMoving
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/AlignmentMoving-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/AlignmentMoving-gnumk_linux_x64-Debug/AlignmentMoving.c.o
	DEP_FILES = ../../../build/AlignmentMoving-gnumk_linux_x64-Debug/AlignmentMoving.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/AlignmentMoving
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/AlignmentMoving-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/AlignmentMoving-gnumk_linux_x64-Release/AlignmentMoving.c.o
	DEP_FILES = ../../../build/AlignmentMoving-gnumk_linux_x64-Release/AlignmentMoving.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f AlignmentMoving-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f AlignmentMoving-Linux_X64.mk all-obj
...
../../../build/AlignmentMoving-gnumk_linux_x64-Debug/AlignmentMoving.c.o ../../../build/AlignmentMoving-gnumk_linux_x64-Debug/AlignmentMoving.c.d: src/AlignmentMoving.c
	$(SILENT) $(info GccX64 src/AlignmentMoving.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/AlignmentMoving-gnumk_linux_x64-Debug/AlignmentMoving.c.o -c src/AlignmentMoving.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/AlignmentMoving-gnumk_linux_x64-Release/AlignmentMoving.c.o ../../../build/AlignmentMoving-gnumk_linux_x64-Release/AlignmentMoving.c.d: src/AlignmentMoving.c
	$(SILENT) $(info GccX64 src/AlignmentMoving.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/AlignmentMoving-gnumk_linux_x64-Release/AlignmentMoving.c.o -c src/AlignmentMoving.c -MMD -MP
...
include ../../../build/AlignmentMoving-gnumk_linux_x64-Debug/AlignmentMoving.c.d

endif

ifeq ($(config),Release)

include ../../../build/AlignmentMoving-gnumk_linux_x64-Release/AlignmentMoving.c.d
