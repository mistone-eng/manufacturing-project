...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_x64d/ReceiveHealth
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveHealth-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveHealth-gnumk_linux_x64-Debug/ReceiveHealth.c.o
	DEP_FILES = ../../../build/ReceiveHealth-gnumk_linux_x64-Debug/ReceiveHealth.c.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_x64/ReceiveHealth
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ReceiveHealth-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ReceiveHealth-gnumk_linux_x64-Release/ReceiveHealth.c.o
	DEP_FILES = ../../../build/ReceiveHealth-gnumk_linux_x64-Release/ReceiveHealth.c.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveHealth-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveHealth-Linux_X64.mk all-obj
...
../../../build/ReceiveHealth-gnumk_linux_x64-Debug/ReceiveHealth.c.o ../../../build/ReceiveHealth-gnumk_linux_x64-Debug/ReceiveHealth.c.d: src/ReceiveHealth.c
	$(SILENT) $(info GccX64 src/ReceiveHealth.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveHealth-gnumk_linux_x64-Debug/ReceiveHealth.c.o -c src/ReceiveHealth.c -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ReceiveHealth-gnumk_linux_x64-Release/ReceiveHealth.c.o ../../../build/ReceiveHealth-gnumk_linux_x64-Release/ReceiveHealth.c.d: src/ReceiveHealth.c
	$(SILENT) $(info GccX64 src/ReceiveHealth.c)
	$(SILENT) $(GNU_C_COMPILER) $(GNU_COMPILER_FLAGS) $(C_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ReceiveHealth-gnumk_linux_x64-Release/ReceiveHealth.c.o -c src/ReceiveHealth.c -MMD -MP
...
include ../../../build/ReceiveHealth-gnumk_linux_x64-Debug/ReceiveHealth.c.d

endif

ifeq ($(config),Release)

include ../../../build/ReceiveHealth-gnumk_linux_x64-Release/ReceiveHealth.c.d
