...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../bin/linux_arm64d/ConsoleExample
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ConsoleExample-gnumk_linux_arm64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ConsoleExample-gnumk_linux_arm64-Debug/ConsoleExample.cpp.o
	DEP_FILES = ../../../build/ConsoleExample-gnumk_linux_arm64-Debug/ConsoleExample.cpp.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../bin/linux_arm64/ConsoleExample
	INTERMEDIATES := 
	OBJ_DIR := ../../../build/ConsoleExample-gnumk_linux_arm64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../build/ConsoleExample-gnumk_linux_arm64-Release/ConsoleExample.cpp.o
	DEP_FILES = ../../../build/ConsoleExample-gnumk_linux_arm64-Release/ConsoleExample.cpp.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ConsoleExample-Linux_Arm64.mk all-dep
	$(SILENT) $(MAKE) -f ConsoleExample-Linux_Arm64.mk all-obj
...
../../../build/ConsoleExample-gnumk_linux_arm64-Debug/ConsoleExample.cpp.o ../../../build/ConsoleExample-gnumk_linux_arm64-Debug/ConsoleExample.cpp.d: src/ConsoleExample.cpp
	$(SILENT) $(info GccArm64 src/ConsoleExample.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ConsoleExample-gnumk_linux_arm64-Debug/ConsoleExample.cpp.o -c src/ConsoleExample.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../build/ConsoleExample-gnumk_linux_arm64-Release/ConsoleExample.cpp.o ../../../build/ConsoleExample-gnumk_linux_arm64-Release/ConsoleExample.cpp.d: src/ConsoleExample.cpp
	$(SILENT) $(info GccArm64 src/ConsoleExample.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../build/ConsoleExample-gnumk_linux_arm64-Release/ConsoleExample.cpp.o -c src/ConsoleExample.cpp -MMD -MP
...
include ../../../build/ConsoleExample-gnumk_linux_arm64-Debug/ConsoleExample.cpp.d

endif

ifeq ($(config),Release)

include ../../../build/ConsoleExample-gnumk_linux_arm64-Release/ConsoleExample.cpp.d
